...
class OurPrincipleController extends Controller
{
    ...
    public function index()
    {
        ...
        $principles = OurPrinciple::orderByDesc('id')->paginate(50);
    ...
    {
        $pageTitle = 'Tambah Principle';

        return view('admin.principles.create', compact('pageTitle'));
    }
    ...
    {
        $pageTitle = 'Ubah Principle';
        $principle = OurPrinciple::find($id);

        return view('admin.principles.edit', compact('pageTitle', 'principle'));
    }
