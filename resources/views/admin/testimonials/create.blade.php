...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row align-items-center d-flex media py-4">
        <div class="col-lg-6 col-12 media-body d-none d-lg-block f-grow-1">
            <h5 class="fw-bold"><span class="text-muted fw-light">Testimoni /</span> Tambah Data</h5>
        </div>
    </div>
    ...
    <div class="col-xxl">
        <div class="card mb-4">
          <div class="card-body">
            <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data" id="LandingPageForm">
              @csrf
              <div class="row">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-select client @error('project_client_id') is-invalid @enderror" id="project_client_id" name="project_client_id">
                            ...
                            @foreach ($clients as $client)
                                <option value="{{ $client->id}}">{{ $client->name.'  -  '. $client->occupation}}</option>
                            @endforeach
                        </select>
                    </div>
