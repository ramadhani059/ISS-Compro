...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row align-items-center d-flex media py-4">
        <div class="col-lg-6 col-12 media-body d-none d-lg-block f-grow-1">
            <h5 class="fw-bold"><span class="text-muted fw-light">Landing Page / Hero Section /</span> Ubah Hero Section</h5>
        </div>
    </div>
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input
                            ...
                            name="achievement"
                            value="{{ $hero_section->achievement }}"
