...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row align-items-center d-flex media py-4">
        <div class="col-lg-6 col-12 media-body d-none d-lg-block f-grow-1">
            <h5 class="fw-bold"><span class="text-muted fw-light">Landing Page /</span> Company Stats</h5>
        </div>
        <div class="col-lg-6 col-12 text-end">
            <a class="btn btn-sm btn-primary" data-toggle="tooltip" href="{{ route('admin.statistics.create' )}}" role="button" aria-haspopup="true" aria-expanded="false">
              ...
              <tr class="text-nowrap">
                ...
                <td>
                    <img
                        ...
                        style="width: 50px;"
                        src="{{ Storage::url($statistic->icon) }}"
                        alt="Hero Section"
                    />
                </td>
                <td>
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <a class="btn btn-icon btn-sm btn-primary me-2" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="<span>Edit</span>" href="{{ route('admin.statistics.edit', ['statistic' => $statistic->id]) }}" role="button" aria-haspopup="true" aria-expanded="false">
                        ...
                        <form action="{{ route('admin.statistics.destroy', $statistic->id) }}" method="POST">
                            @csrf
                            @method('delete')
                            <button type="submit" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="<span>Delete</span>" class="btn btn-icon btn-sm btn-danger" data-name="{{ $statistic->name }}" ><span><iconify-icon icon="bx:trash" class="tf-icons bx"></iconify-icon></span></button>
                        </form>
                    </div>
                </td>
              </tr>
